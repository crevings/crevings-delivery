...
export const ROUTES: RouteDefinition[] = [
  ...
  { path: '/order-history', tab: Tab.ORDER_HISTORY, component: lazy(() => import('@/components/OrderHistoryView').then(m => ({ default: m.OrderHistoryView }))), requiresAuth: true, title: 'Order History' },
  ...
  { path: '/inventory', tab: Tab.INVENTORY, component: lazy(() => import('@/components/InventoryView').then(m => ({ default: m.InventoryView }))), requiresAuth: true, title: 'Inventory' },
  ...
  { path: '/settings', tab: Tab.SETTINGS, component: lazy(() => import('@/components/SettingsView').then(m => ({ default: m.SettingsView }))), requiresAuth: true, title: 'Settings' },
